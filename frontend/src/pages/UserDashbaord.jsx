...
//         const servicesRes = await api.get('/user/services');
//         setServices(servicesRes.data);
//         setFilteredServices(servicesRes.data); // Initialize filtered services
//       } catch (error) {
//         console.error('Error fetching data', error);
//       }
//     };
...
//                 className="pl-10 pr-4 py-2 rounded-md bg-zinc-600 text-zinc-100 border border-zinc-500 focus:outline-none"
//               />
