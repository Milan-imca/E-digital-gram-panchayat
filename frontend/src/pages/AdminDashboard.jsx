      ...
      <div className="bg-zinc-800 shadow-md p-6 rounded-lg mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {applications.map((application) => (
            <div
              key={application._id}
              className="bg-zinc-700 p-4 rounded-lg shadow-md border border-zinc-600 flex flex-col"
            >
              <p className="text-zinc-300"><strong>User:</strong> {application.user.name}</p>
              <p className="text-zinc-400 mt-1"><strong>Service:</strong> {application.service.title}</p>
              <p className="text-zinc-500 mt-1"><strong>Status:</strong> {application.status}</p>
